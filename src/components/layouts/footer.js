        ...
        <div className="row mb-20">
          ...
          >
            <div className="footer__widget mb-30">
              ...
              <p>
                We are many variations of passages of orem psum available but
                the majority have suffered alt/eration in some injected humour.
              </p>
          ...
          <div
            ...
            data-wow-delay=".3s"
          >
            <div className="footer__widget fot_abot mb-30 pl-40">
              ...
              <ul className="fot-list">
                ...
                <li>
                  <a href="#">
                    <i className="far fa-angle-double-right"></i> Become a
                    Volunteer
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#">
                    <i className="far fa-angle-double-right"></i> Global
                    Sponsors
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i className="far fa-angle-double-right"></i> Upcoming
                    Events
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i className="far fa-angle-double-right"></i> Our Photo
                    Gallery
                  </a>
                </li>
              </ul>
          ...
          >
            <div className="footer__widget mb-25">
              <h5 className="semi-02-title mb-25">Upcoming Events</h5>
                ...
                <li>
                  <div className="widget_events d-flex align-items-center mb-20">
                    ...
                    <div className="widget_events__content">
                      <span>
                        <i className="far fa-map-marker-alt/"></i> 59 Dark Road,
                        USA
                      </span>
                      <h4 className="semi-02-title">
          ...
          <div
            ...
            data-wow-delay=".7s"
          >
            <div className="footer__widget fot_abot mb-30 pl-60">
              <h5 className="semi-02-title mb-25">Get In Touch</h5>
              <ul className="widget_address_list">
                <li>
                  <div className="widget_address d-flex mb-20">
                    <div className="widget_address__icon mr-20">
                ...
                <li>
                  <div className="widget_events d-flex mb-20">
                    <div className="widget_address__icon mr-20">
                    ...
                    <div className="widget_address__content">
                      ...
                      <span>
                        <a
                          ...
                          data-cfemail="d2bbbcb4bd92b7aab3bfa2beb7fcb1bdbf"
                        >
                          [email&#160;protected]
                        </a>
                      </span>
            ...
            <div className="col-md-8">
              <div className="copyright">
                <p>
                  ...
                  <a href="#">Carelax</a> All Rights Reserved.
                </p>
              </div>
            </div>
