        ...
        <>
            ...
            <Layout>
                <main>
                                        ...
                                        <div className="col-xl-7">
                                            <div className="slider__content text-left">
                                                ...
                                                <ul className="btn-list wow fadeInUp2 animated" data-wow-delay=".4s">
                                                    <li>
                                                        <a className="theme_btn theme_btn2 theme_btn_bg_02" href="about.html">
                                                            Learn more{" "}
                                                            <span>
                                                    ...
                                                    <li>
                                                        <a className="theme_btn theme_btn_bg" href="case-details.html">
                                                            our cases{" "}
                                                            <span>
                                                                <i className="fas fa-arrow-right"></i>
                                                            </span>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="about-wrapper mb-30">
                                        ...
                                        <p>
                                            There are many variations of passages of orem psum available but the majority have suffered alteration in some form by injected humour or randomised words
                                            which don't look even slightly believable. If you are going to use a passage of orem psum you need to be sure there isn't anything embarrassing hidden in
                                        ...
                                        <ul className="about_list mt-30 mb-20 wow fadeInUp2 animated" data-wow-delay=".2s">
                                            <li>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium quos dolores et quas molestias.</li>
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-xl-4 col-lg-6 col-md-6">
                                    <div className="cases mb-30 wow fadeInUp2 animated" data-wow-delay=".3s">
                                        <div className="cases__box pos-rel">
                                            ...
                                            <ul className="cases__tag white-bg">
                                                ...
                                                <li>
                                                    <a className="theme_btn theme_btn2 theme_btn_bg_02 d-btn" href="donation.html">
                                                        Donate
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div className="cases__content">
                                            ...
                                            <h3>
                                                <a href="donation.html">Help The Children Proverty And Safe World Environment</a>
                                            </h3>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6">
                                    <div className="cases mb-30 wow fadeInUp2 animated" data-wow-delay=".5s">
                                        <div className="cases__box pos-rel">
                                            <div className="cases__box--img">
                                        ...
                                        <div className="cases__content">
                                            ...
                                            <h3>
                                                <a href="donation.html">Financial Help For The Poor Children In The World</a>
                                            </h3>
                                            <p>There are many variations of passages the available but the majority suffered.</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6">
                                    <div className="cases mb-30 wow fadeInUp2 animated" data-wow-delay=".7s">
                                        <div className="cases__box pos-rel">
                                            <div className="cases__box--img">
                                        ...
                                        <div className="cases__content">
                                            ...
                                            <h3>
                                                <a href="donation.html">Children Are Going Hungry Around The World</a>
                                            </h3>
                                            <p>There are many variations of passages the available but the majority suffered.</p>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-10 col-lg-10 col-md-10 mx-auto">
                                ...
                                >
                                    <div className="video-area pos-abl">
                                        <a href="https://www.youtube.com/watch?v=ckHzmP1evNU" className="popup-video">
                    ...
                    <section className="team-area pt-125 pb-100 pos-rel" style={{ backgroundImage: "url( assets/img/bg/team-bg.jpg )" }}>
                        <div className="container">
                            <div className="row">
                                <div className="col-md-7 mx-auto">
                                    <div className="section-title white-title text-center mb-75 pl-50 pr-50 wow fadeInUp2 animated" data-wow-delay=".1s">
                                        <h6>
                                            <span>
                                                <i className="far fa-heart"></i>
                                            </span>{" "}
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay=".3s">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay=".5s">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay=".7s">
                                    <div className="team white-bg clearfix fix pos-rel">
                                        <div className="team__thumb f-left mr-40">
                            ...
                            <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-xl-6 col-lg-6 col-md-6">
                                            <div className="gallery pos-rel text-center wow fadeInUp2 animated" data-wow-delay=".3s">
                                                ...
                                                <div className="gallery__content">
                                                    <a className="popup-image" href="assets/img/gallery/1.jpg">
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6">
                                            <div className="gallery pos-rel text-center wow fadeInUp2 animated" data-wow-delay=".3s">
                                                ...
                                                <div className="gallery__content">
                                                    <a className="popup-image" href="assets/img/gallery/2.jpg">
                                                        <i className="far fa-plus"></i>
                                                    </a>
                                                    <h3>
                                                        <a href="gallery-2.html">Help The Children</a>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6">
                                            <div className="gallery pos-rel text-center wow fadeInUp2 animated" data-wow-delay=".3s">
                                                ...
                                                <div className="gallery__content">
                                                    <a className="popup-image" href="assets/img/gallery/3.jpg">
                                                        <i className="far fa-plus"></i>
                                                    </a>
                                                    <h3>
                                                        <a href="gallery-2.html">Help The Children</a>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6">
                                            <div className="gallery pos-rel text-center wow fadeInUp2 animated" data-wow-delay=".3s">
                                                ...
                                                <div className="gallery__content">
                                                    <a className="popup-image" href="assets/img/gallery/4.jpg">
                                                        <i className="far fa-plus"></i>
                                                    </a>
                                                    <h3>
                                                        <a href="gallery-2.html">Help The Children</a>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="gallery pos-rel text-center wow fadeInUp2 animated" data-wow-delay=".3s">
                                        ...
                                        <div className="gallery__content">
                                            <a className="popup-image" href="assets/img/gallery/5.jpg">
                                                <i className="far fa-plus"></i>
                                            </a>
                                            <h3>
                                                <a href="gallery-2.html">Help The Children</a>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-4">
                                    <div className="testimonial-text-wrapper wow fadeInUp2 animated mb-30" data-wow-delay=".1s">
                                        ...
                                        <p>There are many variations of passages orem sum available but the majority have suffered alteration injected humour.</p>
                                        <a className="theme_btn theme_btn_bg" href="#">
                                            View More{" "}
                                            <span>
                                                <i className="fas fa-arrow-right"></i>
                                ...
                                <div className="col-xl-8 testimonial-wrapper">
                                    <div className="row testimonial-active">
                                        ...
                                        <div className="col-xl-6">
                                            <div className="testimonial-item pos-rel wow fadeInUp2 animated" data-wow-delay=".5s">
                                                <div className="author_box d-flex align-items-center mb-25">
                                                    <div className="author_box__img mr-15">
