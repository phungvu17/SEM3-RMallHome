                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="portfolio-menu text-center mb-25 pr-70 pl-70">
                                        ...
                                        <button data-filter=".cat1">Children</button>
                                        <button data-filter=".cat2">Food</button>
                                        <button data-filter=".cat3">Homeless</button>
                                        <button data-filter=".cat4">Medical</button>
                                        <button data-filter=".cat5">Education</button>
                                    </div>
                                </div>
                            </div>
