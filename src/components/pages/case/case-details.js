                            ...
                            <div className="row">
                                    ...
                                    <div className="cases-details details-left-area pb-100">
                                        <div className="cases cases-wrapper-box wow fadeInUp2 animated" data-wow-delay=".2s">
                                            <div className="cases__content">
                                                ...
                                                <p>
                                                    Vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
                                                    excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et
                                        ...
                                        <div className="cases-feature mb-20">
                                            ...
                                            <p className="mb-30">
                                                ...
                                                blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty
                                        ...
                                        <div className="cases-information">
                                            ...
                                            <p>
                                                Rero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
                                            ...
                                            <div className="doante-select-area donate-select-03 mb-60 mt-40 text-center white-bg wow fadeInUp animated" data-wow-delay=".3s">
                                                ...
                                                <button className="theme_btn theme_btn2 theme_btn_bg_02 large_btn">$400</button>
                                            </div>
                                            <div className="donar-information">
                                                <h3 className="cases-title mb-30">Donate Information</h3>
                                                <div className="row">
                                                    <div className="col-xl-6">
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-12">
                                    <div className="details-right-area">
                                            ...
                                            <div className="widget-post">
                                                ...
                                                <div className="post d-flex align-items-center mb-20">
                                                    ...
                                                    <div className="post__content">
                                                        <h5>
                                                            <a href="blog-details.html">Vero eos et accus et iusto odio dign</a>
                                                        </h5>
                                        ...
                                        <div className="widget mb-30">
                                            <div className="events_wrapper wow fadeInUp2 animated" data-wow-delay=".4s">
                                                <div
                                            ...
                                            <div className="widget-post recent-post">
                                                ...
                                                <div className="post d-flex align-items-center mb-20">
                                                    ...
                                                    <div className="post__content">
                                                        ...
                                                        <span>$400.00</span>
                                                        <p>
                                                            <i className="far fa-calendar-alt"></i> 20 July 2022
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="post d-flex align-items-center mb-20">
